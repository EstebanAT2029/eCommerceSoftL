...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="span-13">
	<fieldset>
	<legend> <?php Yii::t('Article Info', 'Article Information'); ?> </legend>
	<div class="row">
		<?php echo $form->labelEx($model,'category_id'); ?>
		<?php $this->widget('application.modules.YiiShop.components.Relation', array('model' => $model, 'relation' => 'Category', 'fields' => 'title', 'hideAddButton' => true)); ?>
	...
	<div class="span-10">
	<fieldset>
	<legend> <?php Yii::t('Article Data', 'Article Specifications'); ?> </legend>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('shop', 'Create') : Yii::t('shop', 'Save')); ?>
	</div>
